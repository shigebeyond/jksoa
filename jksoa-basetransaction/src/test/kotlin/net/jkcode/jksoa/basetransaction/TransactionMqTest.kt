...
import net.jkcode.jksoa.basetransaction.localmq.TransactionMqManager
...
class TransactionMqTest {
    ...
    fun testAddMq(){
        ...
        db.transaction {
            ...
            // 添加事务消息
            TransactionMqManager.addMq("new user", uid.toString(), topic, "new user: $uid".toByteArray())
        }
